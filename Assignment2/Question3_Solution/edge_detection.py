...
# image_path = f'{home}/tron5A2/ML/images/rosbag2_2025_03_20-16_56_50/0.png'
image_path = f'{home}/tron5A2/ML/Question3_Solution/images/image7.png'
...
if not os.path.exists(image_path):
    ...
    if image is None:
        ...
        save_directory = '/home/jestin/tron5A2/ML/Question3_Solution/cropped_images'
        ...
        for i, cropped_sign in enumerate(cropped_signs):
            save_path = os.path.join(save_directory, f"cropped_sign_{i+1}.png")
